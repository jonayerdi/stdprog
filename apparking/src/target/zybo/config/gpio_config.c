...
/* AXI GPIO */
/* Buttons */
const axi_gpio_id_t axi_gpio_button0 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 1, .pin = 0 };
const axi_gpio_id_t axi_gpio_button1 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 1, .pin = 1 };
const axi_gpio_id_t axi_gpio_button2 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 1, .pin = 2 };
const axi_gpio_id_t axi_gpio_button3 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 1, .pin = 3 };
/* Switches */
const axi_gpio_id_t axi_gpio_switch0 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 2, .pin = 0 };
const axi_gpio_id_t axi_gpio_switch1 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 2, .pin = 1 };
const axi_gpio_id_t axi_gpio_switch2 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 2, .pin = 2 };
const axi_gpio_id_t axi_gpio_switch3 = { .device_id = XPAR_AXI_GPIO_2_DEVICE_ID, .channel = 2, .pin = 3 };
/* Sensors */
const hcsr04_gpio_id_t hcsr04_sensor0 = { .device_id = XPAR_AXI_GPIO_0_DEVICE_ID };
const hcsr04_gpio_id_t hcsr04_sensor1 = { .device_id = XPAR_AXI_GPIO_1_DEVICE_ID };
/* LEDs */
const axi_gpio_id_t axi_gpio_led0 = { .device_id = XPAR_AXI_GPIO_3_DEVICE_ID, .channel = 1, .pin = 0 };
const axi_gpio_id_t axi_gpio_led1 = { .device_id = XPAR_AXI_GPIO_3_DEVICE_ID, .channel = 1, .pin = 1 };
const axi_gpio_id_t axi_gpio_led2 = { .device_id = XPAR_AXI_GPIO_3_DEVICE_ID, .channel = 1, .pin = 2 };
const axi_gpio_id_t axi_gpio_led3 = { .device_id = XPAR_AXI_GPIO_3_DEVICE_ID, .channel = 1, .pin = 3 };
...
int gpio_config_get_input(gpio_input_t *out, const char *gpio_name)
{
	...
	//Sensors
	GPIO_CONFIG_MAP("sensor0", hcsr04_gpio_init(out, hcsr04_sensor0));
	GPIO_CONFIG_MAP("sensor1", hcsr04_gpio_init(out, hcsr04_sensor1));
